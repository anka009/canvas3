...
min_points_calib = st.sidebar.slider(
    "🧮 Minimale Punkte für Auto-Kalibrierung",
...
auto_calibrate_from_calpoints("AEC","aec_cal_points","aec_hsv")
auto_calibrate_from_calpoints("Hämatoxylin","hema_cal_points","hema_hsv")
